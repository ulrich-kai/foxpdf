...
enum FoxPDFEngine {
    ...
    private static func renderPDF(
        ...
        for i in 0..<pdfDoc.pageCount {
            ...
            if downscaleImages {
                ...
                // Für den Nicht-Downscale-Pfad: PDFKit erwartet keinen Flip.
    ...
    private static func renderDownscaled(
        ...
        // PDFKit zeichnet mit Ursprung unten-links (CoreGraphics-Standard).
        // Der BitmapContext hat ebenfalls Ursprung unten-links → kein Flip nötig.
        // Skalierung anwenden damit die Seite den vollen Bitmap ausfüllt.
        ...
        // ctx.draw(image, in:) platziert das Bild mit Ursprung unten-links,
        // passend zum PDF-Koordinatensystem → korrekte Ausrichtung ohne Flip.
